...
def _try_download_from_hub(checkpoint_dir: str):
    ...
    if not repo_id:
        print("  No HF_MODEL_REPO set, skipping HF Hub download.")
        return
